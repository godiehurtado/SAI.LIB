...
namespace ColpatriaSAI.Negocio.Entidades
{
    ...
    public partial class TipoRecaudo: IObjectWithChangeTracker, INotifyPropertyChanged
    {
        ...
        [DataMember]
        public Nullable<int> codigoCAPI
        {
            get { return _codigoCAPI; }
            set
            {
                if (_codigoCAPI != value)
                {
                    _codigoCAPI = value;
                    OnPropertyChanged("codigoCAPI");
                }
            }
        }
        private Nullable<int> _codigoCAPI;
        ...
        private void FixupRecaudoes(object sender, NotifyCollectionChangedEventArgs e)
        {
            ...
            if (e.OldItems != null)
            {
                ...
                {
                    if (ReferenceEquals(item.TipoRecaudo, this))
                    {
                        item.TipoRecaudo = null;
                    }
                    if (ChangeTracker.ChangeTrackingEnabled)
                    {
