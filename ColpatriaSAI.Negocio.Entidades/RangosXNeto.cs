...
namespace ColpatriaSAI.Negocio.Entidades
{
    ...
    public partial class RangosXNeto: IObjectWithChangeTracker, INotifyPropertyChanged
    {
        ...
        private void FixupMatrizComisionVariables(object sender, NotifyCollectionChangedEventArgs e)
        {
            ...
            if (e.OldItems != null)
            {
                ...
                {
                    if (ReferenceEquals(item.RangosXNeto, this))
                    {
                        item.RangosXNeto = null;
                    }
                    if (ChangeTracker.ChangeTrackingEnabled)
                    {
