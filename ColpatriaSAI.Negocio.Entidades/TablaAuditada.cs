...
namespace ColpatriaSAI.Negocio.Entidades
{
    ...
    public partial class TablaAuditada: IObjectWithChangeTracker, INotifyPropertyChanged
    {
        ...
        private void FixupAuditorias(object sender, NotifyCollectionChangedEventArgs e)
        {
            ...
            if (e.OldItems != null)
            {
                ...
                {
                    if (ReferenceEquals(item.TablaAuditada, this))
                    {
                        item.TablaAuditada = null;
                    }
                    if (ChangeTracker.ChangeTrackingEnabled)
                    {
