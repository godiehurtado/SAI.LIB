...
namespace ColpatriaSAI.Negocio.Entidades
{
    ...
    public partial class Combo: IObjectWithChangeTracker, INotifyPropertyChanged
    {
        ...
        public Nullable<int> validado
        {
            ...
            set
            {
                ...
                {
                    _validado = value;
                    OnPropertyChanged("validado");
                }
            }
        }
        private Nullable<int> _validado;
        ...
        private void FixupProductoComboes(object sender, NotifyCollectionChangedEventArgs e)
        {
            ...
            if (e.OldItems != null)
            {
                ...
                {
                    if (ReferenceEquals(item.Combo, this))
                    {
                        item.Combo = null;
                    }
                    if (ChangeTracker.ChangeTrackingEnabled)
