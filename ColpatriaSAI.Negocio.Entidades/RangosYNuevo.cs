...
namespace ColpatriaSAI.Negocio.Entidades
{
    ...
    public partial class RangosYNuevo: IObjectWithChangeTracker, INotifyPropertyChanged
    {
        ...
        private void FixupMatrizComisionVariables(object sender, NotifyCollectionChangedEventArgs e)
        {
            ...
            if (e.OldItems != null)
            {
                ...
                {
                    if (ReferenceEquals(item.RangosYNuevo, this))
                    {
                        item.RangosYNuevo = null;
                    }
                    if (ChangeTracker.ChangeTrackingEnabled)
                    {
