...
namespace ColpatriaSAI.Negocio.Entidades
{
    ...
    public partial class MarcaVehiculo: IObjectWithChangeTracker, INotifyPropertyChanged
    {
        ...
        private void FixupNegocios(object sender, NotifyCollectionChangedEventArgs e)
        {
            ...
            if (e.OldItems != null)
            {
                ...
                {
                    if (ReferenceEquals(item.MarcaVehiculo, this))
                    {
                        item.MarcaVehiculo = null;
                    }
                    if (ChangeTracker.ChangeTrackingEnabled)
                    {
