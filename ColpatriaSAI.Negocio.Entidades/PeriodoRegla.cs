...
namespace ColpatriaSAI.Negocio.Entidades
{
    ...
    public partial class PeriodoRegla: IObjectWithChangeTracker, INotifyPropertyChanged
    {
        ...
        private void FixupReglas(object sender, NotifyCollectionChangedEventArgs e)
        {
            ...
            if (e.OldItems != null)
            {
                ...
                {
                    if (ReferenceEquals(item.PeriodoRegla, this))
                    {
                        item.PeriodoRegla = null;
                    }
                    if (ChangeTracker.ChangeTrackingEnabled)
                    {
