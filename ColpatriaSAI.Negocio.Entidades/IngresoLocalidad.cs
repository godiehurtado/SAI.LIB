...
namespace ColpatriaSAI.Negocio.Entidades
{
    ...
    public partial class IngresoLocalidad: IObjectWithChangeTracker, INotifyPropertyChanged
    {
        ...
        private void FixupLocalidad(Localidad previousValue)
        {
            ...
            if (previousValue != null && previousValue.IngresoLocalidads.Contains(this))
            {
                previousValue.IngresoLocalidads.Remove(this);
            }
    
            if (Localidad != null)
            {
                if (!Localidad.IngresoLocalidads.Contains(this))
                {
                    Localidad.IngresoLocalidads.Add(this);
                }
