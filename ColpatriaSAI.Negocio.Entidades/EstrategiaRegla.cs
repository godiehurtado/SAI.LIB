...
namespace ColpatriaSAI.Negocio.Entidades
{
    ...
    public partial class EstrategiaRegla: IObjectWithChangeTracker, INotifyPropertyChanged
    {
        ...
        private void FixupReglas(object sender, NotifyCollectionChangedEventArgs e)
        {
            ...
            if (e.OldItems != null)
            {
                ...
                {
                    if (ReferenceEquals(item.EstrategiaRegla, this))
                    {
                        item.EstrategiaRegla = null;
                    }
                    if (ChangeTracker.ChangeTrackingEnabled)
                    {
