...
namespace ColpatriaSAI.Negocio.Entidades
{
    ...
    public partial class vw_aspnet_WebPartState_Shared: IObjectWithChangeTracker, INotifyPropertyChanged
    {
        ...
        public System.DateTime LastUpdatedDate
        {
            ...
            set
            {
                if (_lastUpdatedDate != value)
                {
                    if (ChangeTracker.ChangeTrackingEnabled && ChangeTracker.State != ObjectState.Added)
                    {
                        throw new InvalidOperationException("The property 'LastUpdatedDate' is part of the object's key and cannot be changed. Changes to key properties can only be made when the object is not being tracked or is in the Added state.");
                    }
