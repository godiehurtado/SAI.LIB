...
namespace ColpatriaSAI.Negocio.Entidades
{
    ...
    public partial class GrupoEndoso: IObjectWithChangeTracker, INotifyPropertyChanged
    {
        ...
        [DataMember]
        public Nullable<int> claseEndoso
        {
            get { return _claseEndoso; }
            set
            {
                if (_claseEndoso != value)
                {
                    _claseEndoso = value;
                    OnPropertyChanged("claseEndoso");
                }
            }
        }
        private Nullable<int> _claseEndoso;
    
        [DataMember]
        public string estadoReal
        {
            get { return _estadoReal; }
            set
            {
                if (_estadoReal != value)
                {
                    _estadoReal = value;
                    OnPropertyChanged("estadoReal");
                }
            }
        }
        private string _estadoReal;
        ...
        private void FixupNegocios(object sender, NotifyCollectionChangedEventArgs e)
        {
            ...
            if (e.OldItems != null)
            {
                ...
                {
                    if (ReferenceEquals(item.GrupoEndoso, this))
                    {
                        item.GrupoEndoso = null;
                    }
                    if (ChangeTracker.ChangeTrackingEnabled)
                    {
