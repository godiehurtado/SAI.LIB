...
namespace ColpatriaSAI.Negocio.Entidades
{
    ...
    public partial class FactorComisionVariableNeto: IObjectWithChangeTracker, INotifyPropertyChanged
    {
        ...
        private void FixupCompania(Compania previousValue)
        {
            ...
            if (previousValue != null && previousValue.FactorComisionVariableNetoes.Contains(this))
            {
                previousValue.FactorComisionVariableNetoes.Remove(this);
            }
    
            if (Compania != null)
            {
                if (!Compania.FactorComisionVariableNetoes.Contains(this))
                {
                    Compania.FactorComisionVariableNetoes.Add(this);
                }
        ...
        private void FixupTipoContrato(TipoContrato previousValue)
        {
            ...
            {
                if (!TipoContrato.FactorComisionVariableNetoes.Contains(this))
                {
                    TipoContrato.FactorComisionVariableNetoes.Add(this);
                }
        ...
        private void FixupPlanDetalle(PlanDetalle previousValue, bool skipKeys = false)
        {
            ...
            if (PlanDetalle != null)
            {
                if (!PlanDetalle.FactorComisionVariableNetoes.Contains(this))
                {
                    PlanDetalle.FactorComisionVariableNetoes.Add(this);
                }
        ...
        private void FixupProductoDetalle(ProductoDetalle previousValue, bool skipKeys = false)
        {
            ...
            {
                if (!ProductoDetalle.FactorComisionVariableNetoes.Contains(this))
                {
                    ProductoDetalle.FactorComisionVariableNetoes.Add(this);
                }
        ...
        private void FixupRamoDetalle(RamoDetalle previousValue)
        {
            ...
            if (RamoDetalle != null)
            {
                if (!RamoDetalle.FactorComisionVariableNetoes.Contains(this))
                {
                    RamoDetalle.FactorComisionVariableNetoes.Add(this);
                }
        ...
        private void FixupModeloComision(ModeloComision previousValue)
        {
            ...
            {
                if (!ModeloComision.FactorComisionVariableNetoes.Contains(this))
                {
                    ModeloComision.FactorComisionVariableNetoes.Add(this);
                }
