...
namespace ColpatriaSAI.Negocio.Entidades
{
    ...
    [KnownType(typeof(ModalidadPagoDetalle))]
    [KnownType(typeof(ProductosMeta))]
    [KnownType(typeof(Negocio))]
    [KnownType(typeof(Recaudo))]
    [KnownType(typeof(MonedaxNegocio))]
    public partial class ModalidadPago: IObjectWithChangeTracker, INotifyPropertyChanged
    {
        ...
        [DataMember]
        public TrackableCollection<ModalidadPagoDetalle> ModalidadPagoDetalles
        {
            get
            {
                if (_modalidadPagoDetalles == null)
                {
                    _modalidadPagoDetalles = new TrackableCollection<ModalidadPagoDetalle>();
                    _modalidadPagoDetalles.CollectionChanged += FixupModalidadPagoDetalles;
                }
                return _modalidadPagoDetalles;
            }
            set
            {
                if (!ReferenceEquals(_modalidadPagoDetalles, value))
                {
                    ...
                    _modalidadPagoDetalles = value;
                    if (_modalidadPagoDetalles != null)
                    {
                        _modalidadPagoDetalles.CollectionChanged += FixupModalidadPagoDetalles;
                    }
                    OnNavigationPropertyChanged("ModalidadPagoDetalles");
                }
            }
        }
        private TrackableCollection<ModalidadPagoDetalle> _modalidadPagoDetalles;
        ...
        private void FixupModalidadPagoDetalles(object sender, NotifyCollectionChangedEventArgs e)
        {
            if (IsDeserializing)
            {
                return;
            ...
            if (e.NewItems != null)
            {
                foreach (ModalidadPagoDetalle item in e.NewItems)
                {
                    item.ModalidadPago = this;
                    if (ChangeTracker.ChangeTrackingEnabled)
                    {
                        ...
                        ChangeTracker.RecordAdditionToCollectionProperties("ModalidadPagoDetalles", item);
                    }
                }
            }
            ...
            if (e.OldItems != null)
            {
                foreach (ModalidadPagoDetalle item in e.OldItems)
                {
                    if (ReferenceEquals(item.ModalidadPago, this))
                    {
                        item.ModalidadPago = null;
                    }
                    if (ChangeTracker.ChangeTrackingEnabled)
                    {
                        ChangeTracker.RecordRemovalFromCollectionProperties("ModalidadPagoDetalles", item);
                    }
                }
            }
        }
