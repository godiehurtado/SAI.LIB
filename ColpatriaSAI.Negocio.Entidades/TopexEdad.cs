...
namespace ColpatriaSAI.Negocio.Entidades
{
    ...
    public partial class TopexEdad: IObjectWithChangeTracker, INotifyPropertyChanged
    {
        ...
        private void FixupMaestroMonedaxNegocio(MaestroMonedaxNegocio previousValue, bool skipKeys = false)
        {
            ...
            if (previousValue != null && previousValue.TopexEdads.Contains(this))
            {
                previousValue.TopexEdads.Remove(this);
            }
    
            if (MaestroMonedaxNegocio != null)
            {
                if (!MaestroMonedaxNegocio.TopexEdads.Contains(this))
                {
                    MaestroMonedaxNegocio.TopexEdads.Add(this);
                }
        ...
        private void FixupProducto(Producto previousValue, bool skipKeys = false)
        {
            ...
            if (Producto != null)
            {
                if (!Producto.TopexEdads.Contains(this))
                {
                    Producto.TopexEdads.Add(this);
                }
        ...
        private void FixupRamo(Ramo previousValue, bool skipKeys = false)
        {
            ...
            if (Ramo != null)
            {
                if (!Ramo.TopexEdads.Contains(this))
                {
                    Ramo.TopexEdads.Add(this);
                }
        ...
        private void FixupCompania(Compania previousValue, bool skipKeys = false)
        {
            ...
            if (Compania != null)
            {
                if (!Compania.TopexEdads.Contains(this))
                {
                    Compania.TopexEdads.Add(this);
                }
