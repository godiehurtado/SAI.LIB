...
namespace ColpatriaSAI.Negocio.Entidades
{
    ...
    public partial class EstadoParticipante: IObjectWithChangeTracker, INotifyPropertyChanged
    {
        ...
        private void FixupParticipantes(object sender, NotifyCollectionChangedEventArgs e)
        {
            ...
            if (e.OldItems != null)
            {
                ...
                {
                    if (ReferenceEquals(item.EstadoParticipante, this))
                    {
                        item.EstadoParticipante = null;
                    }
                    if (ChangeTracker.ChangeTrackingEnabled)
                    {
