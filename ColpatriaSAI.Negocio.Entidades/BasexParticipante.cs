...
namespace ColpatriaSAI.Negocio.Entidades
{
    ...
    public partial class BasexParticipante: IObjectWithChangeTracker, INotifyPropertyChanged
    {
        ...
        private void FixupParticipante(Participante previousValue, bool skipKeys = false)
        {
            ...
            if (previousValue != null && previousValue.BasexParticipantes.Contains(this))
            {
                previousValue.BasexParticipantes.Remove(this);
            }
    
            if (Participante != null)
            {
                if (!Participante.BasexParticipantes.Contains(this))
                {
                    Participante.BasexParticipantes.Add(this);
                }
