...
namespace ColpatriaSAI.Negocio.Entidades
{
    ...
    public partial class TipoParticipante: IObjectWithChangeTracker, INotifyPropertyChanged
    {
        ...
        private void FixupParticipantes(object sender, NotifyCollectionChangedEventArgs e)
        {
            ...
            if (e.OldItems != null)
            {
                ...
                {
                    if (ReferenceEquals(item.TipoParticipante, this))
                    {
                        item.TipoParticipante = null;
                    }
                    if (ChangeTracker.ChangeTrackingEnabled)
                    {
