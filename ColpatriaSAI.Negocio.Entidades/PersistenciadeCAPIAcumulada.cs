...
namespace ColpatriaSAI.Negocio.Entidades
{
    ...
    public partial class PersistenciadeCAPIAcumulada: IObjectWithChangeTracker, INotifyPropertyChanged
    {
        ...
        [DataMember]
        public Nullable<double> persistenciaAcumulada
        {
            get { return _persistenciaAcumulada; }
            set
            {
                if (_persistenciaAcumulada != value)
                {
                    _persistenciaAcumulada = value;
                    OnPropertyChanged("persistenciaAcumulada");
                }
            }
        }
        private Nullable<double> _persistenciaAcumulada;
    
        [DataMember]
        public Nullable<int> ultimoPeriodo
        {
            get { return _ultimoPeriodo; }
            set
            {
                if (_ultimoPeriodo != value)
                {
                    _ultimoPeriodo = value;
                    OnPropertyChanged("ultimoPeriodo");
                }
            }
        }
        private Nullable<int> _ultimoPeriodo;
        ...
        [DataMember]
        public Nullable<double> recaudosDescontar
        {
            get { return _recaudosDescontar; }
            set
            {
                if (_recaudosDescontar != value)
                {
                    _recaudosDescontar = value;
                    OnPropertyChanged("recaudosDescontar");
                }
            }
        }
        private Nullable<double> _recaudosDescontar;
        ...
        private void FixupJerarquiaDetalle(JerarquiaDetalle previousValue, bool skipKeys = false)
        {
            ...
            if (previousValue != null && previousValue.PersistenciadeCAPIAcumuladas.Contains(this))
            {
                previousValue.PersistenciadeCAPIAcumuladas.Remove(this);
            }
    
            if (JerarquiaDetalle != null)
            {
                if (!JerarquiaDetalle.PersistenciadeCAPIAcumuladas.Contains(this))
                {
                    JerarquiaDetalle.PersistenciadeCAPIAcumuladas.Add(this);
                }
        ...
        private void FixupParticipante(Participante previousValue, bool skipKeys = false)
        {
            ...
            {
                if (!Participante.PersistenciadeCAPIAcumuladas.Contains(this))
                {
                    Participante.PersistenciadeCAPIAcumuladas.Add(this);
                }
        ...
        private void FixupPlazo(Plazo previousValue, bool skipKeys = false)
        {
            ...
            if (Plazo != null)
            {
                if (!Plazo.PersistenciadeCAPIAcumuladas.Contains(this))
                {
                    Plazo.PersistenciadeCAPIAcumuladas.Add(this);
                }
        ...
        private void FixupRamo(Ramo previousValue, bool skipKeys = false)
        {
            ...
            if (Ramo != null)
            {
                if (!Ramo.PersistenciadeCAPIAcumuladas.Contains(this))
                {
                    Ramo.PersistenciadeCAPIAcumuladas.Add(this);
                }
