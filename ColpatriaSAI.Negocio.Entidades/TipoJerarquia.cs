...
namespace ColpatriaSAI.Negocio.Entidades
{
    ...
    public partial class TipoJerarquia: IObjectWithChangeTracker, INotifyPropertyChanged
    {
        ...
        private void FixupJerarquias(object sender, NotifyCollectionChangedEventArgs e)
        {
            ...
            if (e.OldItems != null)
            {
                ...
                {
                    if (ReferenceEquals(item.TipoJerarquia, this))
                    {
                        item.TipoJerarquia = null;
                    }
                    if (ChangeTracker.ChangeTrackingEnabled)
                    {
