...
namespace ColpatriaSAI.Negocio.Entidades
{
    ...
    public partial class Categoria2: IObjectWithChangeTracker, INotifyPropertyChanged
    {
        ...
        private void FixupCategoriaLogs(object sender, NotifyCollectionChangedEventArgs e)
        {
            ...
            if (e.OldItems != null)
            {
                ...
                {
                    if (ReferenceEquals(item.Categoria2, this))
                    {
                        item.Categoria2 = null;
                    }
                    if (ChangeTracker.ChangeTrackingEnabled)
                    {
