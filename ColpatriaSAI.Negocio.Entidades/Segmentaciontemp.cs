...
namespace ColpatriaSAI.Negocio.Entidades
{
    ...
    public partial class Segmentaciontemp: IObjectWithChangeTracker, INotifyPropertyChanged
    {
        ...
        [DataMember]
        public string sucursal_localidad
        {
            get { return _sucursal_localidad; }
            set
            {
                if (_sucursal_localidad != value)
                {
                    _sucursal_localidad = value;
                    OnPropertyChanged("sucursal_localidad");
                }
            }
        }
        private string _sucursal_localidad;
        ...
        private Nullable<int> _segmento;
