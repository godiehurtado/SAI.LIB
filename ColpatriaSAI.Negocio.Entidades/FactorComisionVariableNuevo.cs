...
namespace ColpatriaSAI.Negocio.Entidades
{
    ...
    public partial class FactorComisionVariableNuevo: IObjectWithChangeTracker, INotifyPropertyChanged
    {
        ...
        private void FixupCompania(Compania previousValue)
        {
            ...
            if (previousValue != null && previousValue.FactorComisionVariableNuevoes.Contains(this))
            {
                previousValue.FactorComisionVariableNuevoes.Remove(this);
            }
    
            if (Compania != null)
            {
                if (!Compania.FactorComisionVariableNuevoes.Contains(this))
                {
                    Compania.FactorComisionVariableNuevoes.Add(this);
                }
        ...
        private void FixupTipoContrato(TipoContrato previousValue)
        {
            ...
            {
                if (!TipoContrato.FactorComisionVariableNuevoes.Contains(this))
                {
                    TipoContrato.FactorComisionVariableNuevoes.Add(this);
                }
        ...
        private void FixupPlanDetalle(PlanDetalle previousValue, bool skipKeys = false)
        {
            ...
            if (PlanDetalle != null)
            {
                if (!PlanDetalle.FactorComisionVariableNuevoes.Contains(this))
                {
                    PlanDetalle.FactorComisionVariableNuevoes.Add(this);
                }
        ...
        private void FixupProductoDetalle(ProductoDetalle previousValue, bool skipKeys = false)
        {
            ...
            {
                if (!ProductoDetalle.FactorComisionVariableNuevoes.Contains(this))
                {
                    ProductoDetalle.FactorComisionVariableNuevoes.Add(this);
                }
        ...
        private void FixupRamoDetalle(RamoDetalle previousValue)
        {
            ...
            if (RamoDetalle != null)
            {
                if (!RamoDetalle.FactorComisionVariableNuevoes.Contains(this))
                {
                    RamoDetalle.FactorComisionVariableNuevoes.Add(this);
                }
        ...
        private void FixupModeloComision(ModeloComision previousValue)
        {
            ...
            {
                if (!ModeloComision.FactorComisionVariableNuevoes.Contains(this))
                {
                    ModeloComision.FactorComisionVariableNuevoes.Add(this);
                }
